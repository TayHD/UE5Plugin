...
public:
	...
	float SavedMaxGroundSpeed2 = 600.0f;
 ...
 */
UCLASS()
class FRINKYSCOMPONENTS_API UMyCharacterMovementComponent : public UCharacterMovementComponent
{
	GENERATED_BODY()
...
#pragma region SetValue Functions 
	...
	UFUNCTION(BlueprintCallable, Category = "Smooth Network Movement")
		void SetNewCrouchedHalfHeight(float NewCrouchedHalfHeight);
